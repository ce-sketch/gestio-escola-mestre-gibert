 ...
 * resultats de les proves referencials que se li han passat.
 *
 *   · Matemàtiques — nivell de ConMat (Innovamat) més recent
 *   · Text Escrit (TEE)
 *   · Lectura (VL/CL)
 *
 * Abans aquest fitxer es deia "InformeCatala" perquè només cobria les
